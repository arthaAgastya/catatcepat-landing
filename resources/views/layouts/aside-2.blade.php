    ...
    <div class="aside-toolbar flex-column-auto" id="kt_aside_toolbar">
        ...
        <div class="aside-user d-flex align-items-sm-center justify-content-center py-5">
            ...
            <div class="symbol symbol-50px">
                <img src="{{ asset('') }}assets-2/media/avatars/150-26.jpg" alt="" />
            </div>
            <!--end::Symbol-->
            <!--begin::Wrapper-->
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Logo"
                                            src="{{ asset('') }}assets-2/media/avatars/150-26.jpg" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                @role('super-admin')
                    <div class="menu-item">
                        <a class="menu-link py-3 {{ request()->routeIs('master.role.*') ? 'active' : '' }}"
                            href="{{ route('master.role.index') }}" title="Kelola data role" data-bs-toggle="tooltip"
                ...
                <div class="menu-item">
                    <a class="menu-link py-3 {{ request()->routeIs('transaksi.simpanan.*') ? 'active' : '' }}"
                        href="{{ route('transaksi.simpanan.index') }}" title="Kelola data simpanan anggota koperasi"
                        data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                        data-bs-placement="right">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-muted svg-icon-2"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion {{ request()->routeIs('transaksi.pinjaman.*') ? 'here show' : '' }}">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link {{ request()->routeIs('transaksi.pinjaman.index') ? 'active' : '' }}"
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ request()->routeIs('transaksi.pinjaman.menuPersetujuan') ? 'active' : '' }}"
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ request()->routeIs('transaksi.pinjaman.menuPencairan') ? 'active' : '' }}"
                ...
                <div class="menu-item">
                    <a class="menu-link py-3 {{ request()->routeIs('transaksi.angsuran.index') ? 'active' : '' }}"
                        href="{{ route('transaksi.angsuran.index') }}" title="Kelola data simpanan anggota koperasi"
                        data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                        data-bs-placement="right">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-muted svg-icon-2"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="menu-item">
                    <div class="menu-content pt-8 pb-0">
                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">Laporan Koperasi</span>
                    </div>
                </div>
                <div class="menu-item">
                    <a class="menu-link py-3 {{ request()->routeIs('laporan.simpanan') ? 'active' : '' }}"
                        href="{{ route('laporan.simpanan') }}" title="Lihat laporan detail simpanan anggota"
                        data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                        data-bs-placement="right">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    <a class="menu-link py-3  {{ request()->routeIs('laporan.pinjaman') ? 'active' : '' }}"
                        href="{{ route('laporan.pinjaman') }}" title="Lihat laporan lengkap pinjaman anggota"
                        data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                        data-bs-placement="right">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    <div class="menu-content pt-8 pb-0">
                        <span class="menu-section text-muted text-uppercase fs-8 ls-1">Laporan Akuntansi</span>
                    </div>
                </div>
                <div class="menu-item">
                ...
                <div class="menu-item">
                    <a class="menu-link py-3 {{ request()->routeIs('pencatatan.bb*') ? 'active' : '' }}"
                        href="{{ route('pencatatan.bb') }}" title="Lihat rincian akun dari transaksi yang dicatat"
                        data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                        data-bs-placement="right">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    <a class="menu-link py-3 {{ request()->routeIs('pencatatan.ns*') ? 'active' : '' }}"
                        href="{{ route('pencatatan.ns') }}" title="Lihat keseimbangan antara total debit dan kredit"
                        data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                        data-bs-placement="right">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    <a class="menu-link py-3 {{ request()->routeIs('pencatatan.lpu*') ? 'active' : '' }}"
                        href="{{ route('pencatatan.lpu') }}" title="Lihat laporan perhitungan hasil usaha koperasi"
                        data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                        data-bs-placement="right">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    <a class="menu-link py-3 {{ request()->routeIs('pencatatan.lak*') ? 'active' : '' }}"
                        href="{{ route('pencatatan.lak') }}" title="Lihat laporan arus kas masuk dan keluar koperasi"
                        data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                        data-bs-placement="right">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                ...
                <div class="menu-item">
                    <a class="menu-link py-3" href="#" title="Lihat catatan atas laporan keuangan koperasi"
                        data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                        data-bs-placement="right">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
