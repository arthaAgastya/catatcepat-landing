                                    ...
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="password" class="form-label">Password Baru (Kosongkan
                                                            jika tidak
                                                            diganti)</label>
                                                ...
                                                <div class="col-12 col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="kabupaten_kotamadya"
                                                            class="form-control"
                                    ...
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 mb-3">
                                                    <label for="nomor_induk_kepegawaian" class="form-label required">Nomor
                                                        Induk
                                                        Kepegawaian</label>
                                                    <input type="text" name="nomor_induk_kepegawaian"
                                                        class="form-control"
                                                ...
                                                <div class="col-lg-4 mb-3">
                                                    <label for="nama_ahli_waris" class="form-label">Nama Ahli
                                                        Waris</label>
                                                ...
                                                <div class="col-lg-4 mb-3">
                                                    <label for="hubungan_ahli_waris" class="form-label">Hubungan Ahli
                                                        Waris</label>
                                    ...
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 mb-3">
                                                    <label for="tanda_tangan" class="form-label">Tanda Tangan
                                                        (Opsional)</label>
