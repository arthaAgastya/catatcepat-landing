    ...
    <div class="toolbar py-5 py-lg-5" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            <div class="page-title d-flex flex-column me-3">
                <h1 class="d-flex text-dark fw-bolder my-1 fs-3">Tambah Pengelola</h1>
        ...
        <div class="content flex-row-fluid" id="kt_content">
            <div class="card">
                ...
                <div class="card-body pt-0">
                    <form action="{{ route('master.pengelola.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card mb-4">
                            <div class="card-body">
                                    ...
                                    <div class="col-12 col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="kabupaten_kotamadya"
                                                ...
                                                name="kabupaten_kotamadya" value="{{ old('kabupaten_kotamadya') }}">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" id="tanggal_diangkat"
                                                ...
                                                name="tanggal_diangkat" value="{{ old('tanggal_diangkat') }}">
                                    ...
                                    <div class="col-12 col-lg-4">
                                        <div class="mb-3">
                                            <label for="hubungan_ahli_waris" class="form-label required">Hubungan Ahli
                                                Waris</label>
                        ...
                        <div class="card mb-6">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-4">
                                        <div class="mb-3">
                                            <label for="tanda_tangan" class="form-label required">Tanda Tangan</label>
