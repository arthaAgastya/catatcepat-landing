                    ...
                    <div class="col-12">
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-body pt-0">
                                <form id="formAkun" action="{{ route('master.akun.update', $account->id) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="no_account"
                                                    ...
                                                    name="no_account" value="{{ old('no_account', $account->no_account) }}"
                                                    readonly>
                                                @error('no_account')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                <select name="level" id="level"
                                                    ...
                                                    <option value="1"
                                                        {{ old('level', $account->level) == '1' ? 'selected' : '' }}>1
                                                    </option>
                                                    <option value="2"
                                                        {{ old('level', $account->level) == '2' ? 'selected' : '' }}>2
                                                    </option>
                                                </select>
                                                @error('level')
                                                    <div class="invalid-feedback">{{ $message }}</div>
