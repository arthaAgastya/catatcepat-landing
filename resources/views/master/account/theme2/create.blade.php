                                        ...
                                        <div class="col-12 col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <select name="kelompok" id="kelompok"
                                                    ...
                                                    <option value="Beban Umum & Administrasi">Beban Umum & Administrasi
                                                    </option>
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="no_account"
                                                    ...
                                                    name="no_account" value="{{ old('no_account') }}" readonly>
                                                @error('no_account')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="nama_account"
                                                    ...
                                                    name="nama_account" value="{{ old('nama_account') }}">
                                                @error('nama_account')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                <select name="saldo_normal" id="saldo_normal"
                                                    ...
                                                    <option value="" disabled selected>-- Pilih --</option>
                                                    <option value="debit"
                                                        {{ old('saldo_normal') == 'debit' ? 'selected' : '' }}>Debit
                                                    </option>
                                                    <option value="kredit"
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                <select name="level" id="level"
                                                    ...
                                                    <option value="" disabled selected>-- Pilih --</option>
                                                    <option value="1" {{ old('level') == '1' ? 'selected' : '' }}>1
                                                    </option>
                                                    <option value="2" {{ old('level') == '2' ? 'selected' : '' }}>2
                                                    </option>
                                                </select>
                                                @error('level')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="saldo_awal"
                                                    ...
                                                    name="saldo_awal" value="{{ old('saldo_awal') }}">
                                                @error('saldo_awal')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
