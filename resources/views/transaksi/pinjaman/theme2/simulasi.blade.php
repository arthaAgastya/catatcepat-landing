                            ...
                            <div class="card-body pt-0">
                                <form id="formSimulasi" class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" class="form-control" id="jumlah" placeholder="10000000"
                                            required>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label">Bunga (%)</label>
                                        <input type="number" step="0.1" class="form-control" id="bunga"
                                    ...
                                    <div class="col-md-12">
                                        <button type="button" id="btnHitung" class="btn btn-primary">Hitung
                                            Simulasi</button>
                                    </div>
                                </form>
                            </div>
