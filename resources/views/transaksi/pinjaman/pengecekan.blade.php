                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="pengajuan" name="pengajuan" readonly>
                                </div>
                            </div>
                            <div class="col-12 col-lg-4">
                                <div class="mb-3">
                                    <label class="form-label">Besaran Jasa</label>
                                    <input type="text" class="form-control" id="besaran_jasa" name="besaran_jasa"
                                        readonly>
                                </div>
                            </div>
                            <div class="col-12 col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="biaya_pinjaman" name="biaya_pinjaman"
                                        readonly>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nomor_akad" name="nomor_akad" readonly>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Tanggal Akad</label>
                                <input type="text" class="form-control" id="tanggal_akad" name="tanggal_akad" readonly>
                            </div>
                        </div>
                        {{-- Table Angsuran --}}
                        <div class="mb-3">
