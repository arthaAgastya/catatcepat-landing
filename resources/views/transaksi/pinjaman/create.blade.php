    ...
    <div class="toolbar py-5 py-lg-5" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            <div class="page-title d-flex flex-column me-3">
                <h1 class="d-flex text-dark fw-bolder my-1 fs-3">Tambah Pinjaman</h1>
        ...
        <div class="content flex-row-fluid" id="kt_content">
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    <form action="{{ route('transaksi.pinjaman.store') }}" method="POST" id="formPinjaman" class="row g-3">
                        @csrf
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" id="jumlah_format" class="form-control" placeholder="Rp 10.000.000"
                                value="{{ old('jumlah') }}">
                        ...
                        <div class="col-3">
                            ...
                            <input type="number" step="0.01" name="suku_bunga_tahunan" id="suku_bunga_tahunan"
                                class="form-control @error('suku_bunga_tahunan') is-invalid @enderror" placeholder="9.5"
                                value="{{ old('suku_bunga_tahunan') }}" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="jenis_angsuran" id="jenis"
                                ...
                                <option value="harian" {{ old('jenis_angsuran') == 'harian' ? 'selected' : '' }}>Harian
                                </option>
                                <option value="mingguan" {{ old('jenis_angsuran') == 'mingguan' ? 'selected' : '' }}>
                                    Mingguan</option>
                                <option value="bulanan" {{ old('jenis_angsuran') == 'bulanan' ? 'selected' : '' }}>Bulanan
                                </option>
                                <option value="jatuh_tempo" {{ old('jenis_angsuran') == 'jatuh_tempo' ? 'selected' : '' }}>
                                    Jatuh Tempo</option>
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="besaran_jasa" id="besaran"
                                ...
                                <option value="flat" {{ old('besaran_jasa') == 'flat' ? 'selected' : '' }}>Flat</option>
                                <option value="anuitas" {{ old('besaran_jasa') == 'anuitas' ? 'selected' : '' }}>Anuitas
                                </option>
                                <option value="persen" {{ old('besaran_jasa') == 'persen' ? 'selected' : '' }}>Persen
                                </option>
                            </select>
                            @error('besaran_jasa')
                                <div class="invalid-feedback">{{ $message }}</div>
