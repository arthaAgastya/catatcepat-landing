    ...
    <div class="toolbar py-5 py-lg-5" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            <div class="page-title d-flex flex-column me-3">
                <h1 class="d-flex text-dark fw-bolder my-1 fs-3">Tarik Simpanan Anggota</h1>
                <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-gray-500">Tarik</li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <form action="{{ route('transaksi.simpanan.tarik.store') }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="mb-3">
                                    <label for="jumlah_format" class="form-label required">Jumlah Tarik (Rp)</label>
                            ...
                            <div class="mt-3 text-center">
                                <button type="button" id="btn-submit" class="btn btn-sm btn-success">Simpan</button>
                            </div>
                        </div>
                    </form>
                </div>
