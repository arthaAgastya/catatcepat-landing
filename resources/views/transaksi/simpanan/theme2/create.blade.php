                    ...
                    <div class="col-12">
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-body pt-0">
                                <form action="{{ route('transaksi.simpanan.store') }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-6 mb-3">
                                            <label for="jumlah_pokok_format" class="form-label">Jumlah Simpanan Pokok
                                                (Rp)</label>
                                        ...
                                        {{-- Simpanan Wajib --}}
                                        <div class="col-12 col-lg-6 mb-3">
                                            <label for="jumlah_wajib_format" class="form-label required">Jumlah Simpanan
                                                Wajib
                                                (Rp)</label>
                                            <input type="text" id="jumlah_wajib_format" data-format="rupiah"
                                                data-target="jumlah_wajib"
                                                class="form-control @error('jumlah_wajib') is-invalid @enderror"
                                                placeholder="Rp 0" value="{{ old('jumlah_wajib') }}">
