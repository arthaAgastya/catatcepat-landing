        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <div class="row g-5 g-xl-8">
                    <div class="col-12">
                        <form action="{{ route('transaksi.transaksiNonBarang.store') }}" method="POST"
                            ...
                            <div class="card card-xl-stretch mb-5 mb-xl-8">
                                <div class="card-header border-0 pt-6">
                                    ...
                                    <div class="card-toolbar">
                                        <button type="button" id="add-akun" class="btn btn-sm btn-primary">Tambah
                                            Akun</button>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div id="akun-container">
                                            <p>NB: Tambahkan akun debit dan kredit sesuai kebutuhan. Total nominal
                                                debit harus sama
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-6">
                                                    <strong>Total Kredit: <span id="total-kredit">Rp
                                                            0</span></strong>
                                                </div>
                                            </div>
                                        </div>
