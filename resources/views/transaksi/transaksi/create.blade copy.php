    ...
    <div class="toolbar py-5 py-lg-5" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            <div class="page-title d-flex flex-column me-3">
                <h1 class="d-flex text-dark fw-bolder my-1 fs-3">Tambah Transaksi Lain</h1>
                <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-gray-600">
                        <a href="{{ route('transaksi.transaksi-lain.index') }}"
                            class="text-gray-600 text-hover-primary">Transaksi Lain</a>
                    </li>
                ...
                <div class="card">
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <a href="{{ route('transaksi.transaksi-lain.index') }}" class="btn btn-warning btn-sm">Batal</a>
                        </div>
                    </div>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-8 mb-3">
                                ...
                                <input type="file" name="nota" id="nota_ocr" class="form-control" accept="image/*">
                                <button type="button" id="proses_ocr_invoice" class="btn btn-sm btn-primary mt-2">🔍 Proses
                                    OCR</button>
                        ...
                        <div class="row mb-3 mt-4">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" id="tax_input" name="tax" class="form-control"
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div id="akun-container">
                                <p>NB: Tambahkan akun debit dan kredit sesuai kebutuhan. Total nominal tiap tipe harus sama
        ...
        `);
            ...
            $('#proses_ocr_invoice').click(async function() {
                ...
                img.onload = async () => {
                    ...
                    `);
                        ...
                        status.text('⚠️ Gagal parsing dari AI.');
                    }
                };
                reader.readAsDataURL(file);
            });

            // Format Rupiah otomatis untuk harga, qty, diskon, pajak
            $(document).on('input', '.price-input, #diskon_input, input[name="qty[]"], #tax_input', function() {
                if ($(this).hasClass('price-input') || this.id === 'diskon_input' || this.id ===
                    'tax_input') {
            ...
            function hitungTotalHarga() {
                ...
                $('#form-container .form-row').each(function() {
                    ...
                    const price = parseInt($(this).find('input[name="price[]"]').val().replace(/[^0-9]/g,
                        '')) || 0;
                    total += qty * price;
                });
                ...
                $('input[name="total_transaksi"]').val(finalTotal);
            }
            ...
            function validateTotalNominal(currentInput) {
                ...
                $('#akun-container .akun-row').each(function() {
                    if ($(this).find('input[name="nominal[]"]').is(currentInput)) return; // skip current
