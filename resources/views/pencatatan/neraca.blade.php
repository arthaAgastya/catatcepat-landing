    ...
    <div class="toolbar py-5 py-lg-5" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            <div class="page-title d-flex flex-column me-3">
                <h1 class="d-flex text-dark fw-bolder my-1 fs-3">Laporan Posisi Keuangan</h1>
                <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-gray-500">Laporan Posisi Keuangan</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header border-0 pt-6">
                    <div class="card-title">
                        <h3 class="card-label">Laporan Posisi Keuangan Per {{ now()->translatedFormat('d F Y') }}</h3>
                    </div>
                </div>
